...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/plugins/maps/map-leaflet.css') }}">
    <style>
        body {
        margin: 0;
        padding: 0;
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{ Auth::user()->name }}</span><span class="user-status">Bienvenido!</span></div><div class="avatar bg-success avatar-lg"><span class="avatar-content"> {{ Str::substr(Auth::user()->name, 0,1) }} </span></div>
                    </a>
